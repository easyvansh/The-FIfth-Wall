---
{
  "slug": "masculinity-femininity-and-horror",
  "title": "Masculinity, Femininity, and Horror",
  "subtitle": "The psychic collapse of normality and the gendered architecture of fear.",
  "excerpt": "Horror terrifies us because it reveals that the identities we perform as natural were unstable from the very beginning.",
  "category": "philosophy",
  "tags": ["horror", "psychoanalysis", "cinema", "gender", "lacan", "freud"],
  "publishedAt": "May 5, 2025",
  "readingTime": 26,
  "featured": true,
  "coverImage": "https://selinaargyrou.wordpress.com/wp-content/uploads/2013/10/laurie-strode_786x11742.jpg",
  "order": 10,
  "marginNotes": [
    {
      "anchorText": "normality and the Monster",
      "note": "Robin Wood argues that horror stages conflict between social normality and what culture represses.",
      "type": "source"
    },
    {
      "anchorText": "monstrous-feminine",
      "note": "Barbara Creed argues that patriarchal horror often constructs femininity itself as terrifying.",
      "type": "source"
    },
    {
      "anchorText": "the Final Girl",
      "note": "Carol Clover's influential theory about identification and gender instability within slasher cinema.",
      "type": "source"
    }
  ],
  "backlinks": [
...
A home is no longer safe.
A body no longer obeys itself.
A family hides violence beneath domestic respectability.
A screen becomes haunted.
A woman sees danger that society refuses to acknowledge.
...
In Freud and later psychoanalytic film theory, castration anxiety refers to fear of symbolic loss:
loss of mastery,
loss of power,
loss of identity,
loss of coherent selfhood.

The masculine subject attempts to stabilize itself through systems of order:
law,
surveillance,
rationality,
control.
...
Laurie Strode survives not because she is physically dominant, but because she perceives danger before others do. Horror repeatedly gives women this psychic function:
they register the breakdown of symbolic normality before society acknowledges it.
...
Masculinity wants transcendence:
mind over flesh,
...
We fear with the victim.
Watch through the killer’s gaze.
Pity the monster.
Become complicit in violence.
Then suddenly recognize ourselves inside the monster.
...
Even when the monster dies, something remains unfinished:
the killer returns,
the curse spreads,
the ghost persists,
the survivor remains traumatized.

This matters philosophically.

Horror’s resolution is not restoration of innocence.
It is revelation.
...
Masculinity was never invulnerable.
Femininity was never passive.
The monster was never fully outside us.
