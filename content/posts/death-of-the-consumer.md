---
{
  "slug": "death-of-the-consumer",
  "title": "The Death of Passive Consumption",
  ...
  "marginNotes": [
    {
      "anchorText": "the medium is the message",
      "note": "Marshall McLuhan argued that media technologies reshape human perception and society beyond the content they carry.",
      "type": "source"
    },
    {
      "anchorText": "continuous partial attention",
      "note": "Linda Stone describes modern fragmented attention as a state of constantly scanning for stimulation without deep presence.",
      "type": "source"
    },
    {
      "anchorText": "amusing ourselves to death",
      "note": "Neil Postman warned that entertainment-driven media transforms public discourse into distraction.",
      "type": "source"
    }
  ],
  "backlinks": [
    {
      "title": "Why Most AI Products Still Feel Soulless",
      "slug": "why-ai-products-feel-soulless"
    },
    {
      "title": "Cinema as a Memory Machine",
      "slug": "cinema-as-memory-machine"
    }
  ]
}
---
...
:::callout Psychological note
The most dangerous technologies do not merely give us what we want. They learn what we run toward when we are tired, lonely, anxious, bored, or afraid of ourselves.
:::
